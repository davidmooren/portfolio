...
public class HelloWorldController {
	 ...
	 * you have "annotation-driven" enabled. 
	 * Spring then invokes the validator
	...
	public String saveRegistration(
		...
		model.addAttribute("success", "Estimado " + student.getFirstName()
	...
	// Es una especie de "variable global"
