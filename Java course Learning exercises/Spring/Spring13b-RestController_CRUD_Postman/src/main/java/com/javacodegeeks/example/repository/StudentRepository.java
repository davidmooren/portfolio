...
public class StudentRepository {
	 ...
	 * assign the student id in the repository class. Allowing the client to
	...
	/*
	 * We are using java.util.Optional as a container for our Student object as
	 * it will help us handle cases where Student is null. This is purely an
