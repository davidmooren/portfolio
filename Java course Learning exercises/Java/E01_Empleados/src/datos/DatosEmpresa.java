...
public class DatosEmpresa implements IDatosEmpresa {
	...
	public void addDirector() {
		...
		/*
		 * for (Empleado e : personal) { if (e instanceof Director) {
	...
	public void listado() {
		...
		/*
		 * for (int i = 0 ; i < personal.size(); i++) { Empleado aux =
		 * personal.get(i); System.out.println("Nombre: " + aux.getnombre());
		 * System.out.println(" ");
		 * System.out.println("Salario:"+aux.getsalario()); System.out.println(
		 * " "); }
		 */
		...
		/*
		 * Empleado aux = personal.get(personal.size()); System.out.println(
		 * "Nombre: " + aux.getnombre()); System.out.println(" ");
		 * System.out.println("Salario:"+aux.getsalario()); System.out.println(
		 * " ");
		 */
	}
