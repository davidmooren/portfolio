...
public class EmployeeTestInteractive {
    ...
    public static void main(String[] args) {
        ...
        try (I_EmployeeDAO dao = factory.createEmployeeDAO();
    ...
    public static boolean executeMenu(BufferedReader in, I_EmployeeDAO dao) throws IOException, DAOException {
        Employee emp;
        String action;
        int id;
